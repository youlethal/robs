...
export default function Contact() {
  ...
  const contactInfo = [
    ...
    },
    {
      icon: Mail,
      title: 'Email Us',
      content: 'info@robs .com',
      action: 'Send Email',
      actionLink: 'mailto:info@robs .com'
    },
    {
      icon: Clock,
    ...
    <section id="contact" className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-gray-600 mb-4">Book Your Dining Experience</p>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">Make a reservation for an unforgettable dining experience. Our team is ready to accommodate your special requests and ensure a memorable visit.</p>
        </motion.div>
